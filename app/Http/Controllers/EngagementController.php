...
class EngagementController extends Controller
{
    ...
    public function gettimeline(Request $request){
        ...
        $activities = $activities->whereNotNull('causer_type') // For activities that doesn't have an activity causer_type, like activities generated by seeding.
        ...
        $activities = array_values($activities); // At this point $activities is an associative array. We need a 'linear' array.
        return response()->json([
            "status" => $this->success_status
            , "success" => true
            , "data" => $activities
